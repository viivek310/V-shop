      ...
      <div className="login bg-slate-300 p-5 text-black rounded-lg">
        {login ? <>
          ...
          <form onSubmit={handelSignIn}>
            ...
            <button className="px-2 py-1 mt-5 w-full text-center font-bold bg-slate-400  hover:bg-purple-700 hover:text-white border border-black rounded-md">Log in </button>
        ...
        <div>
          ...
          {login ? <div className="my-2 ">
            ...
            <div className="my-2 ">
              Already have an account?<span onClick={() => setlogin(true)} className="text-blue-600 cursor-pointer">Log in</span>
            </div>
          }
